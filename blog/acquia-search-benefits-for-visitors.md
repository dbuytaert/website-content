...
Acquia Search provides a **more powerful** search because it is based on the renowned open source [Lucene](http://lucene.apache.org/) and [Solr](http://lucene.apache.org/solr/) technologies from the Apache project. Not only do they sport better search algorithms, advanced content normalization, and a "did you mean?" feature, they also come with other great features such as word stemming, document search, range queries and more.
...
That makes for a lot of good reasons why the visitors of your site might care about Acquia Search. Tomorrow, I plan to write [a more technical blog post about how Acquia Search works, how we made it that fast, and why it matters to site administrators](https://dri.es/acquia-search-benefits-for-site-administrators) (instead of site visitors). In the mean time, I recommend that you play around with the search feature on my site or that you [sign up for a trial subscription](https://www.acquia.com/trial). *Have fun!*
