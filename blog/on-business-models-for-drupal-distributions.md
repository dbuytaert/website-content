...
We've began work on Drupal distributions during the Drupal 4.6 era based on our experience with CivicSpace (a distribution for political campaigns). Drupal 5 was a big milestone as we introduced a web-based installer with support for *install profiles*. We made incremental improvements to install profiles in the Drupal 6 release, and it wasn't until Drupal 6 that we saw a number of great Drupal distributions emerge: [OpenAtrium](http://openatrium.com) (an intranet distribution), [Acquia Drupal](https://www.acquia.com/web-content-management-drupal) (a convenience distribution for site builders), [OpenPublish](https://www.phase2technology.com/project/openpublish) (a distribution for online publishers), [Pressflow](http://pressflow.org) (a distribution with performance and scalability improvements) and more. Finally, with some of the install profile related improvements in the upcoming Drupal 7 release and the fact that [we can build and host distributions on drupal.org](https://www.drupal.org/node/647374), I expect to see many more distributions going forward. In summary, we evolved the underlying technology over the course of 5 years and might have reached a point where [our vision of install profiles](https://dri.es/drupal-distributions) can really come to live.
...
We need to figure out how to make it *commercially interesting* (or at a minimum, *commercially viable*) for organizations to invest the time and money it takes to build and maintain a distribution. If not, distributions risk being nothing more than a costly but fun lead generation tool. I don't think that is scalable. To make Drupal distributions the game changer it could be, it has to be a no-brainer for organizations to get into the game of building one. Reducing the maintenance cost through tools like [Drush Make](https://www.drupal.org/project/drush_make) and [the packaging infrastructure on drupal.org](https://www.drupal.org/node/647374) certainly helps, but is probably not enough to make distributions take off in a big way.

At [Acquia](https://www.acquia.com), it occurred to us that we might be able to help. Many Drupal shops lack the go-to-market infrastructure that Acquia built out over the last 2.5 years (i.e. 24x7 help desk, a marketing and sales organization) and that products often need. We can help market and sell offerings around distributions (e.g. 24x7 SLA-based support, hosting, remote administration) and share the revenue with the organization actually building and maintaining the distribution. It is a well-known model in the software world (such as the game industry), and is one example of how we could try to make it commercially interesting to build and maintain distributions.

[Four Kitchens](https://www.fourkitchens.com/) has built a business around offering consulting and support for [Pressflow](http://pressflow.org), the distribution they authored. Pressflow's popularity has driven demand for these services, creating a unique positioning and opportunity for Four Kitchens. [Development Seed](https://www.developmentseed.com) is in the early stages of rolling out their business model for [OpenAtrium](http://openatrium.com), one of the distributions they have created. They announced plans to offer developer support and a paid partner program as key tenets of their business model.
