...
This is great news for three reasons: (1) I've long been [a believer in Drupal distributions](https://dri.es/drupal-distributions), (2) I believe that publishers shouldn't compete through CMS technology, but through strong content and brands, and (3) Thunder is based on Drupal 8.

Distributions enable [Drupal](https://www.drupal.org) to compete against a wide range of turnkey solutions, as well as break into new markets. The number of vertical distributions that can be created is nearly limitless, and the possibilities are endless. [Thunder](http://www.thunder.org) is a great example of that.
...
- [Riddle.com](http://www.riddle.com) provides an easy-to-use editor for interactive content. The data from the resulting polls and quizzes is available to the publisher.
