...
"Ambitious" is a good word because it aligns with the flexibility, scalability, speed, and creative freedom that Drupal provides. Drupal projects may be ambitious because of the sheer scale (e.g. [The Weather Channel](https://dri.es/weather-com-using-drupal)), their security requirements (e.g. [The White House](https://dri.es/whitehouse-gov-using-drupal)), the number of sites (e.g. Johnson &amp; Johnson manages thousands of Drupal sites), or specialized requirements of the project (e.g. the New York MTA powering digital kiosks with Drupal). Organizations are turning to Drupal because it gives them greater flexibility, better usability, deeper integrations, and faster innovation. Not all Drupal projects need these features on day one – or need to know about them – but it is good to have them in case you need them later on.

"Ambitious" also aligns with our community's culture. Our industry is in constant change (responsive design, web services, social media, and IoT), and we never look away. Drupal 8 was a very ambitious release; a reboot that took one-third of Drupal's lifespan to complete, but maneuvered Drupal to the right place for the future that is now coming. I have always believed that the Drupal community is ambitious, and believe that attitude remains strong in our community.
...
PS: I'm borrowing the term "ambitious" from the [Ember.js community](http://emberjs.com). They use the term in their tagline and slogan on their main page.
