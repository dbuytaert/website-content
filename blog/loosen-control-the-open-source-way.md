...
When asked if I had any insights from my work with other large global organizations, it occurred to me the ideal model she is seeking is very aligned to how an Open Source project like [Drupal](https://drupal.com) is managed (a subject I have more than a passing interest in).
...
2. Establish a collaboration model where innovations can be shared back to the rest of the organization, and where each innovation can be analyzed and discussed. This is the essence of Drupal's model with [Drupal.org](https://www.drupal.org) acting as the clearing house for contributions coming in from everywhere in the world.
