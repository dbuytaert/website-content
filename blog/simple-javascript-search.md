...
Just this week I added a search feature to [my blog posts page](https://dri.es/blog).
...
I like that [my blog posts page](https://dri.es/blog) is one long list that is easy to search. What I don't like is that when there is more than one match, iterating through the results causes the search experience to jump around.
