---
url: 'https://dri.es/from-infinite-extensibility-to-infinite-interoperability'
title: 'From infinite extensibility to infinite interoperability'
author:
  name: 'Dries Buytaert'
  url: 'https://dri.es/about'
date: '2008-02-08T08:43:09-05:00'
...
Jeff Whatcott, Acquia's VP of marketing, wrote [an interesting blog post](https://jeffwhatcott.com/drupal/content/dormant-drupal-opportunity) about the term *content management system*, Microsoft SharePoint 2007, and Drupal's opportunity to be the poster child for the social software market space.

The funny thing is that [I replied to Jeff's post back in 2006](https://dri.es/sharepoint-2007). In 2006, I agreed with Jeff – and I still agree with Jeff today – that (i) the term 'content management system' under sells what Drupal is capable of, (ii) that content management systems are consolidating to community and collaboration platforms, and (iii) that SharePoint is mind-boggling in more than one way.
