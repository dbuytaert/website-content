...
The [announcement](http://board.ixda.org/node/11) stated, in part:
...
Additional details about the IxDA's plans for their new home are [available on the IxDA Board Blog](http://board.ixda.org/node/12), including a [PDF outlining the release plan](http://board.ixda.org/sites/board.ixda.org/files/2009-03-10%20release%20plan%20for%20publication.pdf). The IxDA has [put out a call](http://board.ixda.org/node/13) for a qualified Drupal developer to serve as a technical resource and advisor throughout the life of their project. An [IxDA group](https://groups.drupal.org/interaction-designers-network) has also been created on [groups.drupal.org](http://groups.drupal.org) to host discussions about IxDA's Drupal-based platform. *Exciting!*
