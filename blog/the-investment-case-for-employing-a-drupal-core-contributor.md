...
Back in December, [Angie "webchick" Byron](https://www.drupal.org/user/24967) did a [Drupal 8 preview webinar](https://www.acquia.com/resources/acquia-tv/conference/drupal-8-preview-what-expect-december-10-2013) for Acquia. The webinar attracted over 1,000+ attendees. We were able to track that this single piece of content generated $4.5MM in influenced pipeline <sup>[\#2](#fn2)</sup>, of which we've managed to close $1.5MM in business so far.

Even more impressive, [Kevin O'Leary](https://www.drupal.org/user/627430) has done four webinars on [Drupal's newest authoring experience improvements](https://dri.es/announcing-spark-authoring-improvements-for-drupal-7-and-drupal-8). In total, Kevin's webinars helped generate $9MM in influenced pipeline of which almost $4MM closed. And importantly, Kevin had not worked on Drupal prior to joining Acquia! It goes to show that you don't necessarily have to hire from the community; existing employees can be made core contributors and add value to the company.
...
<sup id="fn2">\#2</sup> "Influenced pipeline" means that the content in question was one factor or touch point in what ultimately lead potential customers to become qualified sales leads and contacted by Acquia. On average, Acquia has 6 touch points for every qualified sales lead.
