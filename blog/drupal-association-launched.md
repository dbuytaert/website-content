...
Organizing [last summer's Drupal conference in Brussels](https://dri.es/drupalcon-brussels) would have been a lot easier with some financial backing, for example. Maintaining, scaling, upgrading, and improving the Drupal.org infrastructure is becoming a monumental task.
...
After [talking to various leaders in the Open Source community](https://dri.es/drupal-road-trip-san-francisco), I got together with Dries Knapen and Steven Wittens and we spent days drafting statutes and internal regulations. These were checked by legal advisors, refined, checked and proof-read by various members of the Drupal community until we were confident to incorporate the Drupal Association. Today, the Drupal Association has been incorporated, we assembled the initial board of directors, and we're ready to get to work.
...
You can read more in our [official press release](https://www.drupal.org/associationnode/87) and [the official announcement](https://www.drupal.org/associationnode/71) or simply by checking out the [Drupal Association's website](https://www.drupal.org/association).
