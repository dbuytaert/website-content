...
![Table displaying Drupal cache tags for different cache IDs, showing entity views and associated tags.](http://default/files/cache/drupal/drupal-8-cache-tags-640w.jpg)
...
![A Drupal block configuration window showing cache settings, including maximum cache age and context variation options like URL and user roles.](http://default/files/cache/drupal/drupal-8-cache-contexts-640w.jpg)
