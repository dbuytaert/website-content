...
Things to add? Let me know [using my contact form](https://dri.es/contact) and I'll update the post.
...
- Raised a $19.5 million series B from Benchmark Capital and Index Ventures. Their [Series B pitch deck](https://www.slideshare.net/robinwauters1/mysql-fundraising-pitch-deck-16-million-series-b-round-2003) is available online.
...
- Oracle buys Sleepycat, the company that provides MySQL with the Berkeley DB transactional storage engine. For the most part, the Sleepycat acquisition was a non-event for MySQL AB and users of MySQL.
