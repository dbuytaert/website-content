...
A large part of the program is defined by the attendees so you are encouraged to propose sessions. So, register and submit your ideas for sessions. Even if you don't present a session, you'll enjoy yourself and learn more about getting the most from [Drupal](https://www.drupal.org). Plus, you'll be able to see where DrupalCon got started.
