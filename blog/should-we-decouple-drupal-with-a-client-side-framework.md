...
type: blog
summary: "Progressive decoupling is proposed as Drupal's default, with full decoupling supported and a single client-side framework recommended for progressively decoupled experiences."
tags:
  - Drupal
  - JavaScript
  - 'Headless Drupal'
