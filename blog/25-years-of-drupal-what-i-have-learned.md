...
Most choices don't matter much in hindsight, but a few end up shaping a project's entire trajectory. For Drupal, that included licensing under the GPL, the hook system, the node system, [starting the Drupal Association](https://dri.es/drupal-association-launched), and even the [credit system](https://dri.es/a-method-for-giving-credit-to-organizations-that-contribute-code-to-open-source). You never know which decisions those are when you're making them.
