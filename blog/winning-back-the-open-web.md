...
This blog post is the result of people asking questions and expressing concerns about a few of my last blog posts like [the Big Reverse of the Web](https://dri.es/the-big-reverse-of-the-web), [the post-browser era of the web is coming](https://dri.es/the-post-browser-era-of-the-web-is-coming) and [my DrupalCon Los Angeles keynote](https://dri.es/state-of-drupal-presentation-may-2015). Questions like: Are Walled Gardens good or bad? Why are the Walled Gardens winning? And most importantly; how can the Open Web win? In this blog post, I'd like to continue those conversations and touch upon these questions.
...
At the same time, their dominance is not without concerns. With over 1 billion users each, Google and Facebook are the platforms that the majority of people use to find their news and information. Apple has half a billion active iOS devices and is working hard to launch [applications that keep users inside their walled garden](https://dri.es/the-post-browser-era-of-the-web-is-coming). The two major concerns here are (1) control and (2) privacy.
...
![A table compares data collected by major tech companies, including calendar, purchase history, email, location, and social graph.](http://default/files/images/blog/walled-gardens-data.jpg)
...
![Diagram showing separate platforms \(CMS, Commerce, CRM\), each with its own presentation layer and user data, connected by arrows.](http://default/files/cache/blog/open-web-current-state-640w.jpg)
...
![A layered diagram showing user data separated from applications, managed independently below CMS, commerce, and CRM systems.](http://default/files/cache/blog/open-web-personal-information-broker-640w.jpg)
...
![A personal information broker manages data access between the user and multiple applications.](http://default/files/cache/blog/open-web-shared-broker-640w.jpg)
