...
![A data comparison chart showing how major tech companies collect user information, including email, location, and social connections.](http://default/files/cache/blog/microsoft-linkedin-data-640w.jpg)

I said they won't stop until they know everything about us. Microsoft just bought LinkedIn, so here is what happened:

![A data comparison chart showing how major tech companies collect and use different types of user information.](http://default/files/cache/blog/microsoft-linkedin-data-evolution-640w.gif)
...
In the past I wrote that [data, not software, is eating the world](https://dri.es/the-future-of-software-is-data-driven). The real value in technology comes less and less from software and more and more from data. As most businesses are moving applications into the cloud, a lot of software is becoming free, IT infrastructure is becoming a metered utility, and data is what is really makes or breaks business results. Here is one excerpt from my post: "As value shifts from software to the ability to leverage data, companies will have to rethink their businesses. In the next decade, data-driven, personalized experiences will continue to accelerate, and development efforts will shift towards using contextual data.". This statement is certainly true in Microsoft / LinkedIn's case.

![Diagram comparing Microsoft Graph and LinkedIn Graph, showing connections between elements like emails, contacts, jobs, and hiring managers.](http://default/files/cache/blog/microsoft-linkedin-graphs-640w.jpg)
*Source: Microsoft.*
