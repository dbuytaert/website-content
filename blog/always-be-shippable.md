...
![A diagram showing trunk-based development, where all work is on one main branch, delaying release until all features are ready.](http://default/files/cache/drupal/shippable-trunk-based-development-640w.jpg)
...
![Feature branches merge into the main branch only when ready, enabling independent development and faster releases.](http://default/files/cache/drupal/shippable-feature-branching-640w.jpg)
