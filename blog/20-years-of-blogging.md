...
My history with blogging actually goes back 25 years. Before this site, I started Drop.org, where I shared ideas and experimented with emerging web technologies. Drop.org eventually led me to create [Drupal](https://www.drupal.org/). Drupal 1.0 even included a feature called "public diaries". We didn't call it "blogging" back then, but that is what it was.
...
But the writing is only half of it. The best part happens _after_ you press publish.
