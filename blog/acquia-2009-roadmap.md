...
As we started making plans for 2009, we realized that the best thing we could do, not just for us but also for our partners and the [Drupal community](https://www.drupal.org) at large, is to help tear down the barriers to using Drupal so that it can fulfill its full potential. As a result, much of what Acquia will do in 2009 relates to improving Drupal's adoption rate (e.g. improved usability, increasing awareness, better scalability, commercial-grade support, etc).
...
With the success of the [drupal.org redesign in mind](https://www.drupal.org/node/295037), I wondered if it would be possible for Mark Boulton and Leisa Reichelt to help us improve usability in Drupal itself. Since one of Acquia's key goals is to help expand Drupal adoption, and improving Drupal's usability is key to that, [we decided to hire Mark Boulton to help with Drupal 7](https://dri.es/mark-boulton-to-help-with-drupal-7). We've asked Mark and Leisa to do all their work out in the open, in the Drupal community, so that the community can be involved and give input every step of the way. They have already been brainstorming with some members of Drupal's usability team, but the actual work will start at [DrupalCon DC](http://dc2009.drupalcon.org/) in two weeks.
...
What we offer today in the Acquia Network is just a start. We have a long list of ideas for new services that will enhance Acquia Drupal sites and generally make life easier for site owners. The newest member of the Acquia Network services will we our hosted search offering based on Apache Solr. Acquia Search will provide Drupal site owners multi-site search, better results, faster performance, document search, federated search, and more. We [already blogged about this](https://dri.es/a-hosted-search-service-for-drupal), and we are [recruiting beta testers](https://www.acquia.com/node/229650). We think it has big value for Drupal users.
...
We can't wait to tell you more – at the right time. In the mean time, you can find our roadmap at <https://www.acquia.com/community/projects/acquia-2009-roadmap>.
