...
**Update:** see also Techrunch's coverage: [European social network Netlog to use Mollom's spam filtering tool](https://techcrunch.com/2009/05/19/european-social-network-netlog-to-use-molloms-spam-filtering-tool/).
