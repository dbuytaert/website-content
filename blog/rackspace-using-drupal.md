...
Drupal lends itself perfectly to these kind of sites and allows organizations to get a site up and running quickly. Given that they are looking for feedback on the new site, I'd recommend them to install [Apache Solr](https://www.drupal.org/project/apachesolr) (or to sign up for [Acquia Search](https://www.acquia.com/products-services/acquia-search)), as search facets would make searching their knowledge base both faster and easier. Drupal's custom content types and taxonomy system in combination with Apache Solr's faceted navigation makes for a very powerful knowledge base.
