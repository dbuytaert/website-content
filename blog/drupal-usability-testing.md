...
Nonetheless, there is a lot of work left to be done. I hope that the formal usability testing at the [University of Minnesota Libraries](https://www.lib.umn.edu/) will provide us with a fresh perspective and that it helps train the Drupal community's eye for usability. Because more than anything else, I want to us to flatten the [Drupal learning curve](https://dri.es/drupal-learning-curve).

More information about the usability testing will be made available shortly. The goal is to share some first results at [DrupalCon Boston](http://boston2008.drupalcon.org/) next month.
