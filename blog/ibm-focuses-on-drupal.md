...
What makes this series invaluable is that the articles are written around the basic premise that customization is a necessity. It reinforces that, if we want to create the best content management system in the world, we should focus on [making Drupal (i) easier to use, (ii) easier to develop for, and (iii) easier to theme](/complexity-is-a-disease).
