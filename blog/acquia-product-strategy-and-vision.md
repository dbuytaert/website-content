...
Drupal has the required features to accomplish this today. This is more than a vision – it is reality. Every day, more organizations are [standardizing on Drupal](https://dri.es/one-drupal-to-rule-them-all).
...
The Acquia Network also provides you access to a number of cloud-based services. Services like heartbeat monitoring, software update management, and [soon to be released integration with New Relic](https://dri.es/playing-with-new-relic-on-acquia-hosting) provide visibility into your site's performance and help with site management. Other services, like [Acquia Search](https://www.acquia.com/products-services/acquia-search) and [Mollom](https://mollom.com), extend the functional capabilities of your sites.

We are in the middle of a massive redesign of the [Acquia Network](https://www.acquia.com/products-services/acquia-network) and many of the services you use through the Acquia Network today (including the Acquia Library, a broad collection of tips, tricks, how-to's, and resources for Drupal developers and site owners). Through the Acquia Network you will soon have the ability to easily access a growing list of third-party services, with many available at no additional charge. We already offer many third-party services (e.g. Mollom for spam filtering, New Relic for application profiling, etc), but we'll soon be opening up the Acquia Network as a 'service delivery platform' and marketplace for additional services. In the works for release over the next few months are mobile design tools from Mobify, analytics, video services, marketing tools, and more.
