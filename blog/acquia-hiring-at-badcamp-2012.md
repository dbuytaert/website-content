...
A lot of friendships are made at these events. In the [Drupal community](https://www.drupal.org), we have a saying: "Come for the Code, Stay for the Community". It's intriguing to see these friendships develop. Often times we end up working together; either commercially through [Acquia](https://www.acquia.com), or as volunteers on [Drupal](https://www.drupal.org) itself. This happens for everyone, and it happens often, which is why a lot of Drupal companies use these events to try and hire people.

We're also hiring at Acquia, and [we're hiring people all around the world](https://www.acquia.com/careers). Hiring remains one of our biggest challenges at Acquia. We've seen phenomenal growth as a company, [the fastest growing software company in the US in fact](https://dri.es/acquia-fastest-growing-software-company-in-us), and are continually looking for talented Drupalists looking to make a difference in our customer's lives. Hence, we're setting up a booth at [the job fair at BADCamp](http://2012.badcamp.net/program/drupal-job-fair).
...
And even if Acquia isn't for you, you can help us find great people. We offer [a $2,500 referral bonus](https://www.acquia.com/refer-friend-acquia-2500) to anyone who refers a friend to Acquia that gets hired. It doesn't have to be an existing Drupal developer. That bonus could pay for a ticket to DrupalCon Australia or it may help you fund some of your Drupal contributions.
