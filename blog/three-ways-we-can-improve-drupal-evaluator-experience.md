...
The good news is that the Drupal Association recognizes the same needs, and in the past few months, we have been working together on plans to improve Drupal's conversion funnel. The Drupal Association will share [its 2018 execution plans](https://www.drupal.org/association/blog/drupal-association-2018-execution-plan) in the coming weeks. As you'll see, the plans address some of the pain points for evaluators (though not necessarily through a hosted trial service, as that could take significant engineering and infrastructure resources).
