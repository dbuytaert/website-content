...
type: blog
summary: 'Marking 15 years since Drupal 1.0.0, reflecting on early GPL and node-based decisions, missteps like OpenID, and the road ahead.'
tags:
  - Drupal
  - Birthday
published: true
...
In the end, I feel fortunate that our community is willing to experiment and break things to stay relevant. Most recently, with the [release of Drupal 8](https://dri.es/drupal-8-released), we've made [many big changes](https://dri.es/why-the-big-architectural-changes-in-drupal-8) that will fuel Drupal's continued adoption. I believe [we got a lot of things right in Drupal 8](https://www.garfieldtech.com/blog/drupal8-happy-not-satisfied) and that we are on the brink of another new and bright era for Drupal.

I've undergone a lot of personal reinvention over the past 15 years too. In the early days, I spent all my time writing code and building [Drupal.org](https://www.drupal.org). I quickly learned that a successful Open Source project requires much more than writing code. As Drupal started to grow, I found myself an "accidental leader" and worried about our culture, scaling the project, attracting a strong team of contributors, focusing more and more on Drupal's end-users, growing the commercial ecosystem around Drupal, [starting the Drupal Association](https://dri.es/drupal-association-launched), and providing vision. Today, I wear a lot of different hats: manager of people and projects, evangelist, fundraiser, sponsor, public speaker, and [BDFL](https://en.wikipedia.org/wiki/Benevolent_dictator_for_life). At times, it is difficult and overwhelming, but I would not want it any other way. I want to continue to push Drupal to reach new heights and new goals.

Today we risk losing much of the privacy, serendipity and freedom of the web we know. As the web evolves from a luxury to a basic human right, it's important that we treat it that way. To increase our impact, we have to continue to make Drupal easier to use. I'd love to help [build a world where people's privacy is safe](https://dri.es/winning-back-the-open-web) and Drupal is more approachable. And as the pace of innovation continues to accelerate, we have to think even more about [how to scale the project](https://dri.es/scaling-open-source-communities), remain agile and encourage experimentation. I think about these issues a lot, and am fortunate enough to work with some of the smartest people I know to build the best possible version of the web.
