...
![A basketball player in a red jersey jumps and performs a slam dunk during a game.](http://default/files/cache/drupal/drupal-8-nba-640w.gif)
...
## 2. [Nasdaq](https://www.westuc.com/en-us/digital-media/webcasting-webhosting/webhosting)

https://www.youtube.com/watch?v=s2HTiiNBuzo

[Nasdaq Corporate Solutions has selected Drupal 8](https://dri.es/nasdaq-using-drupal-8-for-new-investor-relations-websites) as the basis for its next generation Investor Relations Website Platform. IR websites are where public companies share their most sensitive and critical news and information with their shareholders, institutional investors, the media and analysts. With Drupal 8, Nasdaq Corporate Solutions will be providing companies with the most engaging, secure, and innovative IR websites to date.

## 3.[Hubert Burda Media](http://www.hubert-burda-media.com)

![A magazine cover featuring a model in a blue outfit with bold makeup, including dramatic eyeliner.](http://default/files/cache/drupal/drupal-8-burda-640w.gif)

For more than 100 years, Hubert Burda Media has been Germany's premier media company. Burda is using Drupal 8 to expand their traditional business of print publishing to reach more than 52 million readers online. Burda didn't stop there, the media company also open sourced [Thunder](https://www.drupal.org/project/thunder), a distribution for professional publishers built on Drupal 8.

## 4. [Jurassic World](http://www.jurassicworld.com)

![A man holds out his arms to stop three approaching velociraptors in a Jurassic World-themed website banner.](http://default/files/cache/drupal/drupal-8-jurassic-world-640w.gif)
...
## 5. [WWF](http://www.wwf.org.uk)

![A red fox stands alert in natural surroundings, with a WWF logo displayed on the left side.](http://default/files/cache/drupal/drupal-8-wwf-640w.gif)
...
## 6. [YMCA Greater Twin Cities](https://www.ymcamn.org)

![A man in a suit dances on a stage, making YMCA hand gestures with a blue curtain behind him.](http://default/files/cache/drupal/drupal-8-ymca-640w.gif)
...
## 8. [Al Jazeera Media Network](http://www.aljazeera.com)

![Al Jazeera news website homepage showing headlines about protests in Egypt and violence in Mosul.](http://default/files/cache/drupal/drupal-8-al-jazeera-640w.gif)

Al Jazeera is the [ largest news organization focused on the Middle East](https://dri.es/how-al-jazeera-successfully-managed-through-the-turmoil), and broadcasts news and current affairs 24 hours a day, 7 days a week. Al Jazeera required a platform that could unify several different content streams and support a complicated editorial workflow, allowing network wide collaboration and search. Drupal 8 allowed Al Jazeera to do that and then some. Content creators can now easily deliver critical news to their readers in real time.

## 9. [Alabama.gov](http://www.alabama.gov)

![Alabama government website homepage with a "Be Bold" slogan and options to renew fishing, hunting, vessel, and driver licenses.](http://default/files/cache/drupal/drupal-8-alabama-gov-640w.gif)
...
## 10. [Box](https://www.box.com)

![A glittery silver box opens to reveal a blue Drupal logo inside, then closes again.](http://default/files/cache/drupal/drupal-8-box-640w.gif)
...
## 11. [Habitat for Humanity](https://www.habitat.org/)

![A Habitat for Humanity webpage displays a map highlighting regions in Asia and the Pacific where they build homes.](http://default/files/cache/drupal/drupal-8-habitat-for-humanity-640w.gif)
...
## 12. [Obermeyer](https://www.obermeyer.com)

![A snowboarder carves through deep snow, kicking up a spray of powder while riding downhill.](http://default/files/cache/drupal/drupal-8-obermeyer-640w.gif)
...
I can't think of a better way to celebrate Drupal 8's one year anniversary than by sharing some incredible experiences that are being created with Drupal 8. Whether the project is big or small, features dinosaurs, or spreads awareness for an important cause, I'm proud to say that Drupal 8 is supporting an amazing array of projects. In my recent [keynote at DrupalCon Dublin](https://dri.es/state-of-drupal-presentation-september-2016), I explained why [the why of Drupal](https://dri.es/drupal-collective-purpose) is so important. After one year of Drupal 8, it's clear how powerful our collective purpose, projects, and passions can be.

Thank you to everyone who has continued to contribute to Drupal 8! I can't wait for another year of exciting projects. Special thanks to [Paul Johnson](https://www.drupal.org/u/pdjohnson) for crowdsourcing great examples that I wouldn't have known about otherwise.
