---
url: 'https://dri.es/acquia-retrospective-2013'
title: 'Acquia retrospective 2013'
author:
  name: 'Dries Buytaert'
  url: 'https://dri.es/about'
date: '2014-01-09T10:47:24-05:00'
...
As is now a tradition, here is my annual Acquia retrospective. Time to look back at 2013. In your life, you only get an opportunity to do so many things, so you have to focus on doing things that matter. I'm fortunate that [Drupal](https://www.drupal.org) and [Acquia](https://www.acquia.com) are remarkable stories. I take time to write these retrospectives for you and for me. I write them for you, because you might benefit from my experiences or from analyzing the information provided. But I also write them for myself so I don't forget this incredible journey. If you want, you can read previous retrospectives: [2009](https://dri.es/acquia-retrospective-2009), [2010](https://dri.es/acquia-retrospective-2010), [2011](https://dri.es/acquia-retrospective-2011) and [2012](https://dri.es/acquia-retrospective-2012).
...
With regards to Acquia's software products, it was certainly our busiest year. Not only did we continue to invest heavily in Acquia Cloud and Acquia Network, we also launched some new products. [Acquia Commerce Cloud](https://www.acquia.com/solutions/commerce) was unveiled last quarter, providing a platform for creating content-rich, socially enabled shopping experiences. Acquia Cloud Site Factory was also released, providing a platform for launching and managing hundreds of websites. We unveiled [Drupal Commons 3.0](http://commons.acquia.com/), our Drupal-based community platform, that was [identified a Social Platform leader by Forrester Research](https://www.acquia.com/resources/whitepaper/acquia-named-leader-forrester-wave-web-content-management-systems-q1-2017). And we delivered the general availability release of the [Mollom Content Moderation Platform](https://www.mollom.com/moderation), a content moderation platform built for the enterprise.

The cloud continues to prove to be a great way for organizations to save money, manage websites more efficiently and bring them to market faster. And Drupal is no exception to this trend – in 2013, many organizations decided to standardize on Drupal in a big way, moving away from the variety of different systems – exactly [the vision we laid out in 2010](https://dri.es/acquia-product-strategy-and-vision).
...
- Our product teams sponsored work on numerous important community modules, such as [Media](https://www.drupal.org/project/media), [Organic Groups](https://www.drupal.org/project/og), and more ...
- The authoring experience work for Drupal 8 that we started last year landed in core this year, including [WYSIWYG](https://www.drupal.org/node/1890502) and in-place editing. We also sponsored work on [redesigned content creation page](https://wunder.io/blog/better-content-creation-page-drupal-8) and [an improved blocks UI](http://www.winstondodger.com/posts/block-ui-overhaul) for Drupal 8.
- Also on Drupal 8, we sponsored work on the [Web Services](https://groups.drupal.org/wscci) and [Migrate in Core](https://groups.drupal.org/imp) initiatives, donating the Migrate module authors' time.
- We helped set up numerous process improvements to help streamline Drupal 8 core development, including various ["hard problems"](https://groups.drupal.org/node/324278) discussions at DrupalCons to work through complex issues, releasing [monthly alpha releases](https://groups.drupal.org/node/364138) for user and developer feedback, and [laying out the criteria for beta 1](https://dri.es/the-next-step-for-drupal-8-is-a-beta). We've also helped establish communication channels to help promote what is happening in Drupal 8: the [This Week In Core](https://groups.drupal.org/taxonomy/term/98113) series, and the [Drupal 8.0 landing page](https://www.drupal.org/8).
- We helped the Drupal Association to establish [Drupal.org Working Groups](https://www.drupal.org/governance/drupalorg-working-groups) to provide better leadership and transparency to the Drupal website. Some of our team also helped assist on Drupal.org upgrade and security issues.
