---
url: 'https://dri.es/drupal-cms-2-released'
title: 'Drupal CMS 2.0 released'
author:
  name: 'Dries Buytaert'
...
tags:
  - Drupal
  - 'Drupal Starshot'
image: blog/drupal-cms-2-released
published: true
featured: false
id: 6076
---
...
With Drupal CMS 2.0, we're taking another big step forward. You no longer begin with a blank slate. You can begin with [site templates](https://dri.es/exploring-a-marketplace-for-drupal-site-templates) designed for common use cases, then shape them to fit your needs. You get a visual page builder, preconfigured content types, and a smoother editing experience out of the box. We also added more AI-powered features to help draft and refine content.

The biggest new feature in this release is [Drupal Canvas](https://dri.es/drupal-canvas-1-0-released), our new visual page builder that now ships by default with Drupal CMS 2.0. You can drag components onto a page, edit in place, and undo changes. No jumping between forms and preview screens.
