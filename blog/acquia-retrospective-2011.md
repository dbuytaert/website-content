...
While 2011 was only Acquia's third full year in business (i.e. revenue-bearing year), 2011 was absolutely jam-packed. Starting with [executing on our product strategy and vision](https://dri.es/acquia-product-strategy-and-vision), to [a trip to the Caribbean for the entire company](https://dri.es/acquia-goes-to-the-caribbean), to being [selected by Forbes magazine as one of America's 100 most promising companies](https://www.forbes.com/lists/2011/28/most-promising-companies-11_Acquia_UNVV.html), 2011 was full of amazing successes, both for Drupal and for Acquia.
...
Acquia, along with our partners, had more and more engagements with big and well-known organizations, like [Paypal](https://www.x.com/), [Twitter](https://dev.twitter.com/), [Al Jazeera](http://blogs.aljazeera.com/), [World Economic Forum](https://www.weforum.org/), the [U.S. House of Representatives](https://www.house.gov/), and many more.
...
Because things went so well, we decided to accelerate sales and marketing and raised more money mid-2011. We raised [$15 million](https://dri.es/acquia-raises-15-million-series-d) in a fourth round of funding. Our previous investors affirmed their confidence by participating in this round, and they were joined by [Tenaya Capital](https://www.tenayacapital.com/).
...
In addition to adding our own services, we also added complimentary services and tools from our partners, including [New Relic](https://www.newrelic.com) (performance monitoring), Drupalize.me (over 200 hours of Drupal video training from [Lullabot](https://www.lullabot.com/)), Blitz.io (load testing), Utest (crowd sourced manual testing), and Mobify (mobile delivery of Drupal sites). Lastly we re-built the Acquia Library, our knowledge base on everything Drupal and Acquia. Everything combined, we made massive improvements to the Acquia Network.
...
A major low-light was the famous [Amazon outage in April 2011](https://www.cnet.com/8301-30685_3-20056029-264.html). Even though only two enterprise customers were affected, out of a couple hundred at that time, we made fairly significant changes to our roadmap to limit future outages. We've since added features to Acquia Cloud like multi-datacenter failover (both multi-region and multi-availability zone across continents) to increase the service level agreement (SLA) we provide to levels beyond what Amazon provides directly.

2011 was also the year that we commercially launched [Drupal Gardens](http://www.drupalgardens.com/) at DrupalCon Chicago after spending considerable design and engineering time on the new Views 3 user interface. Since then, Drupal Gardens has added many requested features and now is hosting over 75,000 Drupal 7 sites including some really large enterprise customers, though we can't talk about them quite yet.

We also did a lot of other things; from [relaunching Acquia.com on Drupal 7](https://dri.es/rebirthing-acquia-com), to adding support for Drupal 7 and Drupal 8 to Acquia Dev Desktop, to improving both Acquia Commons and COD.
...
Roughly 30% of our engineering time flows back to the Drupal community and resulted in numerous improvements, including core bug fixes, contributed module porting, and usability improvements to modules such as Date, Media, and Views. We participated in the [University of Minnesota usability testing](https://www.drupal.org/node/1175694), in addition to performing more than 20 internal usability tests on Drupal and Drupal Gardens whose results have been fed into the community.

We participated in and organized many sprints, including the [Drupal 7 media sprint](https://groups.drupal.org/node/173749), the Drush Code Sprint, and [Multilingual Drupal Code Code Sprint](https://evolvingweb.ca/blog/montreal-multilingual-drupal-code-sprint).
...
Acquia is obviously interested in helping to make Drupal the best it can possibly be and we're proud of major contributions we make to the Drupal project. For example, due to concerns about the lack of Drupal marketing, we launched the Drupal Showcase site as a resource to enable the community to help market Drupal. And since the adoption and growth of Drupal is vitally important, I, supported by the rest of the Acquia leadership team, made a decision to [fund a major usability initiative ](https://dri.es/mark-boulton-to-help-with-drupal-7) during Drupal 7's development.
...
We've always been very transparent about our goals and roadmap ([Acquia 2009 roadmap](https://dri.es/acquia-2009-roadmap), [Acquia 2011 product strategy](https://dri.es/acquia-product-strategy-and-vision)), so in the next month or two, I'll provide more information on Acquia's goals for 2012 and beyond.
