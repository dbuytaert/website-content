...
First, I talked about new features for Acqiua's Drupal Cloud. All features are focused on helping developers migrate, develop, design and launch [Drupal](https://www.drupal.org/) sites faster.

I covered the following new features for Acquia's Drupal Cloud:

- **Acquia Migrate:** A family of products that help you migrate to [Drupal 9](https://dri.es/drupal-9-released) five times faster and easier.
