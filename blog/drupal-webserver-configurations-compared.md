...
![Bar chart comparing Drupal performance with and without APC caching, showing higher requests per second with APC enabled.](http://default/files/images/drupal/drupal-4.7-apc-vs-noapc.jpg)
...
![Bar chart comparing PHP4 and PHP5 performance, showing requests per second for different page types with anonymous and authenticated visitors.](http://default/files/images/drupal/drupal-4.7-php4-vs-php5.jpg)
...
![Bar chart comparing Apache and Lighttpd performance, showing requests per second for anonymous and authenticated visitors on different pages.](http://default/files/images/drupal/drupal-4.7-apache-vs-lighttpd.jpg)
