...
What the use case didn't mention is that they are migrating off of [FatWire](http://fatwire.com), a proprietary web content management system (WCMS) that is Forrester's current poster child in the [Q2 2009 Forrester Wave for "Web Content Management For External Sites"](https://www.forrester.com/rb/Research/wave%E2%84%A2_web_content_management_for_external_sites,/q/id/48024/t/2). To me, that is the most interesting part because it means that Drupal is starting to disrupt traditional web content management systems, including the leading ones.
