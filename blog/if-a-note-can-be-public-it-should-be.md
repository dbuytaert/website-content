...
Writers like [Tom Critchlow](https://tomcritchlow.com/wiki/), [Maggie Appleton](https://maggieappleton.com/garden-history), and [Andy Matuschak](https://notes.andymatuschak.org/) maintain what they call *digital gardens*. They showed me that a personal website does not have to be a collection of polished blog posts. It can be a living space where ideas can grow and evolve. Think of it more as an ever-evolving notebook than a finished publication, constantly edited and updated over time.

I also learned from [Simon Willison](https://simonwillison.net/), who publishes small, focused *[Today I Learned (TIL)](https://til.simonwillison.net/) entries*. They are quick, practical notes that capture a moment of learning. They don't aim to be comprehensive; they simply aim to be useful.

And then there is [Cory Doctorow](https://pluralistic.net/). In 2021, he explained [his writing and publishing workflow](https://pluralistic.net/2021/01/13/two-decades/#hfbd), which he describes as a kind of *personal memex*. A memex is a way to record your knowledge and ideas over time. While his memex is not public, [I found his approach inspiring](https://dri.es/building-a-personal-memex).

I try to take a lot of notes. For the past four years, my tool of choice has been [Obsidian](https://obsidian.md). It is where I jot things down, think things through, and keep track of what I am learning.

In Obsidian, I maintain a [Zettelkasten](https://zettelkasten.de/introduction/) system. It is a method for connecting ideas and building a network of linked thoughts. It is not just about storing information but about helping ideas grow over time.
...
So a few years ago, I began publishing these kinds of notes on my site. You might have seen examples like [Principles for life](https://dri.es/principles-for-life), [PHPUnit tests for Drupal](https://dri.es/phpunit-tests-for-drupal), [Brewing coffee with a moka pot when camping](https://dri.es/brewing-coffee-with-a-moka-pot-when-camping) or [Setting up password-free SSH logins](https://dri.es/setting-up-password-free-ssh-logins).
