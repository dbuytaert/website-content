...
title: "Drupal's AI roadmap for 2026"
author:
  name: 'Dries Buytaert'
...
image: drupal/drupal-ai-roadmap-2026
discussions:
  - { platform: LinkedIn, url: 'https://www.linkedin.com/posts/buytaert_drupal-drupal-ai-share-7427443455401816065-T7IU/' }
published: true
featured: false
id: 6096
---
...
The full plan is [available as a PDF](https://dri.es/files/drupal-ai-roadmap-2026.pdf), but let me explain the thinking behind it.
...
[Drupal](https://www.drupal.org/) has always been built around the realities of serious content work: structured content, workflows, permissions, revisions, moderation, and more. These capabilities are what make quality possible at scale. They're also exactly [the foundation AI needs](https://dri.es/why-drupal-is-built-for-the-ai-era) to actually work well.
...
* [QED42](https://www.qed42.com/) is focused on innovation, pushing forward on what is next. 
* [1xINTERNET](https://www.1xinternet.com/) is focused on productization, taking what we've built and making it stable, intuitive, and easy to install.
...
And if you want to [join the initiative as an official partner](https://new.drupal.org/ai/become-a-maker), we'd absolutely welcome that.
...
PS: Follow the discussion on [LinkedIn](https://www.linkedin.com/posts/buytaert_drupal-drupal-ai-share-7427443455401816065-T7IU/).
