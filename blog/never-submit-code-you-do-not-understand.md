---
url: 'https://dri.es/never-submit-code-you-do-not-understand'
title: "Never submit code you don't understand"
author:
  name: 'Dries Buytaert'
...
![Blue and red graphic with a white star and the text: "Never submit code you don't understand."](http://default/files/cache/blog/never-submit-code-you-dont-understand-640w.png)
...
Code you don't understand becomes someone else's problem. In Open Source, that someone is often [the maintainer reviewing your patch](https://dri.es/ai-creates-asymmetric-pressure-on-open-source). 
...
*Thanks to [Natalie Cainaru](https://www.drupal.org/u/cainaru), [Jeremy Andrews](https://www.drupal.org/u/jeremy) and [Gábor Hojtsy](https://www.drupal.org/u/gábor-hojtsy) for reviewing my draft.*

PS: Follow the discussion on [LinkedIn](https://www.linkedin.com/feed/update/urn:li:share:7439337611762139137/).
