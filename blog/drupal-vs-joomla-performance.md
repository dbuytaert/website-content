...
![A Drupal webpage displaying a blog post with a user login section and an online users list.](http://default/files/images/drupal/drupal-post.jpg)
![A Joomla-based webpage displaying a test post with a login form and navigation menu.](http://default/files/images/drupal/joomla-post.jpg)
