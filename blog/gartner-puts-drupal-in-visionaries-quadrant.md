...
Here is what Nikos Drakos, Research Director at Gartner wrote about Drupal's promotion: <q>Drupal is in the Visionaries quadrant because of its use of the open source model to drive adoption and popularity, while providing enterprise services via organizations such as Acquia. Its strong content-centric, community and web application foundation is being rapidly extended with hundreds of modules, including many for collaboration and social interaction support.</q>
