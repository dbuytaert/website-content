...
Jeff Robbins from [Lullabot](http://www.lullabot.com) is helping me contact people and set up my schedule. We set up personal meetings with some of the smartest people in the FOSS and internet community:
...
As well as all of these "official" meetings, I would love to connect with the local Drupal community. We're leaving at least Thursday evening (the 29th) open for a Drupal meetup, but there should be other opportunities to hang out. Check the [Bay Area Drupal group](https://groups.drupal.org/bay-area) for details on time and place.
