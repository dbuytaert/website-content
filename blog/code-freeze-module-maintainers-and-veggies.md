...
type: blog
summary: "Maintaining the Mollom module during Drupal 7's code freeze improved both the module and Drupal Core, so module maintainers are encouraged to upgrade early."
tags:
  - Drupal
  - Mollom
published: true
