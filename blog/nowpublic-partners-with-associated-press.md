...
To put this into perspective, on any given day, more than half the world's population sees news from AP – so this is an unparalleled distribution opportunity for [citizen created content](/traditional-media-and-citizen-journalism) and contributors to NowPublic. And of course, as NowPublic is built on Drupal, it's good news for Drupal too.
