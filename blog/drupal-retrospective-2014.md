...
October 1, 2014, amidst the fanfare at [DrupalCon Amsterdam](https://amsterdam2014.drupal.org/), we released [Drupal 8 beta 1](https://dri.es/drupal-8-beta-1-released). This was an important milestone in the project, marking the finalization of major APIs, which enables contributed modules to begin porting in earnest.

### Total number of Drupal 8 contributors surpasses 2,500

Our 2,500th core contributor was [Tasya Rukmana (tadityar)](https://www.drupal.org/u/tadityar), a high-school student participating in [Google Code-in 2014](https://www.google-melange.com/archive/gci/2014)! Awesome.

### Kick-starting contributed modules in Drupal 8

Drupal 8's new object-oriented API represents a significant paradigm shift for developers (there are many [benefits to this](https://dri.es/why-the-big-architectural-changes-in-drupal-8)). To help Drupal 7 pros make the jump to Drupal 8, Acquia funded the [Drupal Module Upgrader](https://www.drupal.org/project/drupalmoduleupgrader) project. This project will not only scan a Drupal 7 module and generate a report pointing off to the appropriate [documentation](https://www.drupal.org/list-changes/drupal) on how to port it, there is even a mode that automatically re-writes much of your module's code to Drupal 8 to eliminate a huge chunk of the work.
...
Our current focus is resolving the [Drupal 8 upgrade path issues](https://www.drupal.org/project/issues/search?projects=&project_issue_followers=&status%5B%5D=1&status%5B%5D=13&status%5B%5D=8&status%5B%5D=14&status%5B%5D=4&priorities%5B%5D=400&issue_tags_op=%3D&issue_tags=D8+upgrade+path), which will allow early adopters of Drupal 8 to upgrade their site data between beta releases, and should result in a further uptick to Drupal 8 development velocity.

Once we reach [zero critical issues](https://www.drupal.org/project/issues/search/drupal?status%5B0%5D=1&status%5B1%5D=13&status%5B2%5D=8&status%5B3%5D=14&status%5B4%5D=4&priorities%5B0%5D=400&categories%5B0%5D=1&categories%5B1%5D=2&version%5B0%5D=8.x), we begin the release candidate phase. Among the areas left to polish up after the Drupal 8 upgrade path issues are bringing external libraries up to date, finalizing documentation, and performance.

#### Continuous improvements after Drupal 8

Unlike prior versions of Drupal, [Drupal 8 has adopted a new release cycle](https://www.drupal.org/node/2383987) that will provide backwards-compatible "feature" releases every 6 months. I'm extremely excited about this change, as it means we can innovate on the core platform for years to come after release, versus holding all of the new goodies until Drupal 9.
