...
In addition, Acquia advanced to become a "Leader" in the [Omdia Digital Experience Management Universe Report](https://omdia.tech.informa.com/OM023763/Omdia-Universe-Selecting-a-Digital-Experience-Management-Platform-Solution-202223), was named an "Outperformer" in the GigaOm Radar Report for DXPs, and was included on [Constellation Shortlists](https://www.acquia.com/newsroom/press-releases/acquia-constellation-shortlist) across seven categories, including DXP, CMS, CDP, and DAM.
...
Drupal has long been known for its ability to effectively manage and deliver content across various channels and customer touchpoints. In 2022, Drupal made significant strides with the release of [Drupal 10](https://dri.es/drupal-10-released), a major milestone that has taken 22 years to achieve.

The Drupal 10 release was covered by numerous articles on the web so I won't repeat the main Drupal 10 advancements or features in my retrospective. I do want to highlight Acquia's contributions to its success. [Acquia was founded with the goal of supporting Drupal](https://dri.es/acquia-my-drupal-startup) and, 16 years later, we continue to fulfill that mission as the largest corporate contributor to Drupal 10. I am proud of the work we have done to support the Drupal community and the release of Drupal 10.

I also wanted to provide an update on Acquia DAM. In 2021, [Acquia acquired Widen](https://dri.es/acquia-to-acquire-widen), a digital asset management platform (DAM), and rebranded it as Acquia DAM. In 2022, we integrated it into both Drupal and Acquia's products.
...
The growth of Open Source software has paralleled the adoption of cloud technology. In 2022, developers initiated [52 million new Open Source projects on GitHub](https://github.blog/2022-11-17-octoverse-2022-10-years-of-tracking-open-source/) and made over 413 million contributions to existing Open Source projects. 90% of companies report using Open Source code in some manner.
