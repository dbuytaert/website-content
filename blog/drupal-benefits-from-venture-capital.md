...
I know bootstrapping is hard because I'm bootstrapping [Mollom](https://mollom.com). I know building a product is hard because every day at [Acquia](https://www.acquia.com), I see how much time and effort goes into our different products.

I don't have a rich uncle, so I would not have been able to co-found [Acquia](https://www.acquia.com) without venture capital financing. We decided that we wanted to focus on being a support and software product company with a strong partner eco-system. Starting Acquia wasn't the easiest route for me, but looking back at the past three years of Acquia, I believe that I made the right decision. Based on how much Acquia has contributed to [Drupal](https://www.drupal.org) and what it has enabled me to do, I like to believe it would have been a loss if I had taken a more conventional route – or had I decided to continue to work on Drupal as a hobby project.
